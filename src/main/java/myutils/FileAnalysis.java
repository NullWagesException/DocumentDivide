...
public class FileAnalysis{
    ...
    public static List<String> Analysis(File file) {
    ...
    public static File Divide(File file, String format) {
        return null;
    }
     ...
     * @param path
     */
    public static void writeDataDocx(String path,List<String> list,boolean jiacu,int size) {
...
//        fa.createWord("D:","test.docx");
//        fa.writeDataDocx("D://test.docx","[1].《计算机研究与发展》各类参考文献的著录格式及示例[J].计算机研究与发展,2004(10):1727.",false,12);
        List<String> analysis = FileAnalysis.Analysis(new File("D:\\myDownload\\QQfile\\3.docx"));
        if (analysis == null){
            System.out.println("文献格式错误！");
        }else{
            for (String str : analysis) {
                System.out.println(str);
                System.out.println(DFormat.getStandardType(str));
            }
        }
    }
