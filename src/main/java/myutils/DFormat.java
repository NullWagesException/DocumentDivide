...
public class DFormat {
    ...
    public static void main(String[] args) {
        String str_M = "[5] Gill, R. Mastering English Literature [M]. London: Macmillan, 1985: 42-45.";
        String str_C = "[9] Norris, F. & I.Gordon. “Can the Subaltern Speak?”[A]. In C.Nelson & L. Grossberg(eds.). Victory in Limbo: Imigism [C]. Urbana: University of Illinois Press, 1988, pp.271-313.";
        String str_N = "[7] Norris, F. & I.Gordon. Between Silences: A Voice from China[N]. Atlantic Weekly, 1987-8-15(33).";
        String str_J = "[2]Pottie G J, Kaiser W J. Wireless integrated network sensors[J]. Communications of the Acm, 1999, 43(5):51-58.";
        String type = getStandardType(str_J);
        System.out.println(type);
        String ddata = getDdata(str_J, type,"aaa");
